...
export default function ContactSection({ notify }) {
  ...
  const socials = [
    { label: 'Telegram', href: 'https://t.me/demiee_01', color: '#0088cc',
    ...
    { label: 'TikTok', href: 'https://www.tiktok.com/@demiee_01', color: '#ff0050',
    ...
    { label: 'Gmail', href: 'mailto:demiee34@gmail.com', color: '#ea4335',
