...
export default function GithubSection({ notify }) {
  ...
  return (
    <div ref={ref} className="w-full max-w-2xl lg:max-w-3xl flex flex-col items-center gap-8 md:gap-10 lg:gap-12">

      {/* Heading */}
      <div className="text-center" style={anim()}>
      ...
      {/* Single card */}
      <div className="w-full glass glass-border rounded-2xl sm:rounded-3xl p-5 sm:p-7 md:p-8 lg:p-10 flex flex-col gap-5 md:gap-6" style={anim(100)}>
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <a href={REPO_URL} target="_blank" rel="noreferrer"
             className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-white/70 transition-all duration-200 hover:text-white no-underline shrink-0"
        ...
        <div className="flex flex-col gap-3">
            <p className="text-xs font-semibold uppercase tracking-widest text-white/50">Clone this repo</p>
      ...
      <a href={GITHUB_URL} target="_blank" rel="noreferrer"
         ...
         style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.2)', ...anim(350) }}>
