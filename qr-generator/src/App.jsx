      ...
      <section id="home" className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-8 md:px-12 lg:px-16 py-24">
        <div className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl flex flex-col gap-4 md:gap-5 lg:gap-7">
          ...
          <div className="glass glass-border rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-9 lg:p-12 flex flex-col gap-4 sm:gap-5 md:gap-6 lg:gap-7">
            ...
            {/* Result */}
            {generated && (
              <div className="fade-up flex flex-col items-center gap-4 sm:gap-5 md:gap-6 pt-2">
                <div className="flex flex-col items-center gap-1">
                  <span className="text-xs md:text-sm font-semibold uppercase tracking-widest text-white/50">Your QR Code</span>
                  <div className="w-8 md:w-12 h-0.5 rounded-full" style={{ background: 'linear-gradient(90deg,#60a5fa,#a78bfa)' }} />
                </div>

                <div ref={qrRef} className="qr-pop p-4 sm:p-5 md:p-6 lg:p-7 rounded-2xl md:rounded-3xl bg-white shadow-2xl hover:-translate-y-1 transition-transform duration-300">
                  <QRCodeCanvas value={url} size={qrSize}
                    fgColor="#1e3c72" bgColor="#ffffff" level="H"
                    style={{ borderRadius: 8, display: 'block' }} />
                </div>

                <div className="flex items-center gap-2 px-4 md:px-5 py-2 md:py-2.5 rounded-full text-white/80 text-xs md:text-sm font-semibold"
                     style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.15)' }}>
                  <svg className="w-3.5 h-3.5 md:w-4 md:h-4 text-green-400" viewBox="0 0 24 24" fill="currentColor">
